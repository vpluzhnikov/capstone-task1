...
public class TopOntimeAirportS2Cas extends Configured implements Tool {

	static final String KEYSPACE = "aviation";
    static final String OUTPUT_COLUMN_FAMILY = "q2_2";
    
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new TopOntimeAirportS2Cas(), args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        jobA.setJarByClass(TopOntimeAirportS2Cas.class);
...
//        FileOutputFormat.setOutputPath(jobB, new Path(args[1]));
        ...
        String query = "UPDATE " + KEYSPACE + "." + OUTPUT_COLUMN_FAMILY + " SET destination = ?, fcount = ? ";
...
//        jobB.setOutputFormatClass(TextOutputFormat.class);
        ...
        jobB.setJarByClass(TopOntimeAirportS2Cas.class);
	...
	@Override
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
			...
			try {
				...
				mkey = new Text(tokens[4].trim() + ";" + tokens[6].trim());
        ...
        protected void cleanup(Context context) throws IOException, InterruptedException {
			for ( Map.Entry<Text, TreeMap<Integer,TextArrayWritable>> entry : bigStat.entrySet() ) {
				...
				//for ( TextArrayWritable el : nset.values() ) {
					...
					airport = tuple[0];
					//context.write(airport, new Text("Destination: "+tuple[1]+", Flight count: "+tuple[2]));
